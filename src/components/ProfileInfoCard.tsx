...
export default function ProfileInfoCard({
  ...
  return (
    <div className="rounded-b-3xl border-x border-b border-zinc-200/80 bg-white shadow-[0_20px_60px_rgba(0,0,0,0.08)] ring-1 ring-black/5">
      <div className="p-6">
        {/* Header info */}
      ...
      {/* Action buttons */}
      <div className="border-t border-zinc-200/50 bg-zinc-50/30 p-4 rounded-b-3xl">
        <div className="flex gap-3">
          ...
          <a
            ...
            className="flex-1 rounded-2xl px-6 h-12 flex items-center justify-center text-sm font-semibold text-white outline-none ring-offset-2 focus:ring-2 active:scale-[0.98] transition-all duration-200 shadow-lg shadow-black/10 hover:brightness-110"
          >
